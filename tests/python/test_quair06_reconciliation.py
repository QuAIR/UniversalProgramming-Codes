...
INVENTORY = ROOT / "docs/provenance/quair06-live-inventory.json"
...
NEW_MATS = {
    ...
    "results/diagnostic/quair06_struct2_d3_k1.mat",
    "results/diagnostic/quair06_struct2_d3_k2.mat",
    "results/diagnostic/quair06_struct3_d4_k1.mat",
    "results/diagnostic/quair06_struct3_d4_k2.mat",
    "results/diagnostic/quair06_y3_d4_k3.mat",
    "results/diagnostic/quair06_y3_d5_k2.mat",
    "results/diagnostic/quair06_yalmip_d3_k2.mat",
}


class Quair06ReconciliationTest(unittest.TestCase):
    @staticmethod
    def _inventory():
    ...
    def test_exact_k56_log_is_compact_and_k6_is_not_claimed_solved(self):
        path = ROOT / "results/logs/quair06_exact_k56_checkpoint.csv"
        ...
        log = (ROOT / "results/logs/quair06_exact_k56_checkpoint.log").read_text(
            encoding="utf-8"
        )
    ...
    def test_pbt_snapshot_is_explicitly_historical(self):
        readme = ROOT / "legacy/server-snapshots/quair06-2026-08-07/README.md"
        text = readme.read_text(encoding="utf-8")
        self.assertIn("recovered claim", text)
        self.assertIn("not independently re-proven", text)
        self.assertTrue(
            (ROOT / "legacy/server-snapshots/quair06-2026-08-07/pqga/pbt_bound/pbt_bound.py").is_file()
        )
    ...
    def test_matlab_loads_k5_blocks_and_incomplete_k6_without_solving(self):
        ...
        script = (ROOT / "tests/matlab/test_quair06_evidence.m").as_posix()
    ...
    def test_no_internal_sdd_files_are_tracked(self):

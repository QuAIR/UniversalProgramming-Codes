...
cfg = up_config();
up_setup(cfg, true);
outputDir = fullfile(cfg.resultsRoot, 'quair06', 'general_d', 'validated');
...
save(fullfile(outputDir, sprintf("y3_d%d_k%d.mat",d,k)),"cost","d","k","s","b1","b2","p1","p2","cvx_status","mineig","maxnh","tpres","fres");

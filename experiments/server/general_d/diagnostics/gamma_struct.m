...
cfg = up_config();
up_setup(cfg, false);
outputDir = fullfile(cfg.resultsRoot, 'server', 'general_d', 'diagnostics');
...
save(fullfile(outputDir, sprintf("struct_d%d_k%d.mat",d,k)),"cost","d","k","s","b1","b2","p1","p2","cvx_status","e1","e2","fres","tpr1","tpr2");
fprintf("saved\n");

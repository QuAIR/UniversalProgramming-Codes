...
I_d   = eye(d);
addpath(genpath("<QETLAB_ROOT>")); rng(7);
...
cost = p1 + p2;
if ~exist("results","dir"); mkdir("results"); end; save(sprintf("results/gamma_d%d_k%d_s%d_r%d.mat",d,k,s,7),"cost","d","k","s","method","cvx_status");

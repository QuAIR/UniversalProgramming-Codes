%% run_quair06_linear_k14.m -- quair06 simplified SDP run, k=1..4
%
...
for idx = 1:numel(ks)
    ...
    save(fullfile(outputDir, 'kcopy_d2_quair06_linear_k14_partial.mat'), ...
...
disp(T);
writetable(T, fullfile(outputDir, 'kcopy_d2_quair06_linear_k14.csv'));
save(fullfile(outputDir, 'kcopy_d2_quair06_linear_k14.mat'), 'T', ...
    'ks', 'gam_linear', 'pplus_linear', 'pminus_linear', ...
    'status_linear', 'runtime_linear', 'info_linear');

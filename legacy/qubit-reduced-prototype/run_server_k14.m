%% run_server_k14.m -- server batch run for gamma_k(CPTP, d=2), k=1..4
%
...
for idx = 1:numel(ks)
    ...
    save(fullfile(outputDir, 'kcopy_d2_server_updated_k14_partial.mat'), ...
...
disp(T);
writetable(T, fullfile(outputDir, 'kcopy_d2_server_updated_k14.csv'));
save(fullfile(outputDir, 'kcopy_d2_server_updated_k14.mat'), 'T', ...
    'ks', 'gam_full', 'gam_linear', 'gap_full_minus_linear', ...
    'linear_lower_bound_ok', 'binding_flag', ...
    'pplus_full', 'pminus_full', 'pplus_linear', 'pminus_linear', ...
    'status_full', 'status_linear', 'runtime_full', 'runtime_linear');

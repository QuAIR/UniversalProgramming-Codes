# Server Reconciliation and Rerun Note

The live server reconciliation was completed read-only on 2026-08-07. The 57
...
[`server-live-inventory.json`](server-live-inventory.json).
...
[`../../experiments/server/kcopy_d2/run_exact_k56.m`](../../experiments/server/kcopy_d2/run_exact_k56.m),

...
> Historical implementation checklist retained for development provenance.
...
### Task 3: Restore Exact Qubit Tests and server Batch Definitions

**Files:**
- Create: `experiments/server/config/README.md`
- Create: `experiments/server/kcopy_d2/run_exact_k14.m`
- Create: `experiments/server/kcopy_d2/run_exact_k56.m`
- Create: `experiments/server/kcopy_d2/run_exact_k14.sh`
- Create: `experiments/server/kcopy_d2/run_exact_k56.sh`
- Create: `experiments/server/kcopy_d2/launch_exact_k14.sh`
- Create: `experiments/server/kcopy_d2/launch_exact_k56.sh`
- Create: `experiments/server/kcopy_d2/README.md`
...
Recover the historical `run_server_exact_k14.m` and `run_server_exact_k56.m`, rename them as listed, and initialize paths through `up_config` and `up_setup`. Both runners set:
...
```powershell
Select-String -Path experiments\server\kcopy_d2\* -Pattern "linear|/home/|private-address"
...
```powershell
git add experiments/server/config experiments/server/kcopy_d2 tests/matlab
...
**Files:**
- Create: `experiments/server/general_d/README.md`
- Create: `experiments/server/general_d/cert_d2_k3.m`
- Create: `experiments/server/general_d/cert_d2_k4.m`
- Create: `experiments/server/general_d/cert_d4_k2.m`
- Create: `experiments/server/general_d/cert_d5_k2.m`
- Create: `experiments/server/general_d/gamma_struct3.m`
- Create: `experiments/server/general_d/gamma_y3.m`
- Create: `experiments/server/general_d/validate_fastP.m`
- Create: `experiments/server/general_d/diagnostics/fit_analytic.py`
- Create: `experiments/server/general_d/diagnostics/gamma_struct.m`
- Create: `experiments/server/general_d/diagnostics/gamma_struct2.m`
- Create: `experiments/server/general_d/diagnostics/gamma_y.m`
- Create: `experiments/server/general_d/diagnostics/probe_d4k4.m`
...
```powershell
python tools/verify_repository.py
Get-ChildItem -Recurse -File experiments\server\general_d | Select-String -Pattern "/home/|private-address|research-user"
```
...
```powershell
git add experiments/server/general_d
...
- Create: `legacy/qubit-reduced-prototype/run_server_k14.m`
- Create: `legacy/qubit-reduced-prototype/run_server_k14.sh`
- Create: `legacy/qubit-reduced-prototype/launch_server_k14.sh`
- Create: `legacy/qubit-reduced-prototype/README.md`
- Create: `legacy/linear-relaxation/run_server_linear_k14.m`
- Create: `legacy/linear-relaxation/run_server_linear_k14.sh`
- Create: `legacy/linear-relaxation/launch_server_linear_k14.sh`
...
- Create: `docs/provenance/server-rerun-plan.md`
...
- Create: `experiments/server/README.md`
...
- a statement that no live server reconciliation was performed in this local-only phase.
...
`experiments/server/README.md` documents the environment variables and shows:

```bash
export UP_CVX_ROOT=/path/to/cvx
export UP_QETLAB_ROOT=/path/to/QETLAB-0.9
export UP_RESULTS_ROOT=/path/to/output
./experiments/server/kcopy_d2/launch_exact_k14.sh
```
...
```powershell
git add README.md docs/experiment-manifest.md experiments/server/README.md experiments/server/*/README.md results/README.md legacy/*/README.md tests/python/test_repository.py
...
python -m unittest discover -s tests/python -v
python tools/verify_repository.py
python -m py_compile src/python/irrep_dimensions.py src/python/sk_invariance_reduction.py figures/make_fig3_kcopy_decay.py experiments/server/general_d/diagnostics/fit_analytic.py
